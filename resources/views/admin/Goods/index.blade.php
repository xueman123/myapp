...
<link href="/homes/css/index.min.css" rel="stylesheet" type="text/css">

<div class = "row" style = "margin-left:30px">
    <div class="col-md-11">
    @foreach($type as $k => $val)
    <a class="btn btn-outline-primary" href="/admin/type/{{$val->id}}" role="button" style = "margin:5px">{{$val->tname}}</a>
    @endforeach
    </div>
</div>
<div class="content">
                                    ...
                                    role="grid" aria-describedby="bootstrap-data-table_info">
                                        ...
                                        @foreach ($res as $k => $v)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a href="/admin/type/{{$v['types']->id}}">{{$v['types']->tname}}</a>
                                                </td>
                                                <td>
                                                    <img src="{{$v->pic}}" alt="" height = "100">
                                                </td>
                                                <td>
                                                    {{$v->descr}}
                                                </td>
                                                ...
                                                <td class = "color" gid = "{{$v->id}}">
                                                    @foreach  ($v['color'] as $k => $val)
                                                        <li style = 'list-style:none;'  >
                                                            ...
                                                            <a href="javascript:" style = "float:right"><i class="fa ti-settings" ids = "{{$val->id}}"></i>
                                                        </li>
